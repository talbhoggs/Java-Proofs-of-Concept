...
public class App {
	public static void main(String[] args) {
		...
		*/
		...
		List<com.daniel.models.Resident> residentList = new ArrayList<com.daniel.models.Resident>();
		
		Resident r1 = new Resident();
		r1.setName("Resident 1");
		
		Resident r2 = new Resident();
		r2.setName("Resident 2");
		
		Resident r3 = new Resident();
		r3.setName("Resident 3");

		Resident r4 = new Resident();
		r4.setName("Resident 4");
